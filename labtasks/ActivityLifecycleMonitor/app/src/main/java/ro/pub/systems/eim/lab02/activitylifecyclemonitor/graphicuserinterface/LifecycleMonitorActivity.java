...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else Log.d(Constants.TAG, "onCreate() method was invoked without a previous state");
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        usernameEditText.setText(savedInstanceState.getString("username_text"));
        passwordEditText.setText(savedInstanceState.getString("password_text"));
    }
}
